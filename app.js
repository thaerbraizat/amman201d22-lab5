...
function sumAndMultiply(a, b, c) {
  ...
  return [w , e ,`${a} and ${b} and ${c} sum to ${w}.`,`The product of ${a} and ${b} and ${c} is ${e}.`];
}
...
function sumArray(sumArr) {
  ...
  let f = sumAndMultiply(testArray[0],testArray[1],testArray[2])[0];

  return[f,`2,3,4 was passed in as an array of numbers, and ${f} is their sum.`];
...
function multiplyArray(multArr) {
  let t = sumAndMultiply(testArray[0],testArray[1],testArray[2])[1];
